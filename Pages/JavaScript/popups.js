function abrirDescritiva() {
        ...
        document.getElementById("tabela-probUniforme").style.display ='none'
        document.getElementById("tabela-probNormal").style.display ='none'
        document.getElementById('pontoFuturo').style.display ='none'
        document.getElementById("tabela-correlacao").style.display ='none'
