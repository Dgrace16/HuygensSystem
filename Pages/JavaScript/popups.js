function abrirDescritiva() {
        document.getElementById('popupDescritiva').style.display='block'
        document.getElementById('popupProbabilidadeEscolha').style.display='none'
        document.getElementById('popupCorrelacao').style.display='none'
        document.getElementById('popupProbabilidadeUniforme').style.display='none'
...
function abrirProbabilidadeEscolha() {
        ...
        document.getElementById('popupProbabilidadeEscolha').style.display='block'
        document.getElementById('popupCorrelacao').style.display='none'
        document.getElementById('popupProbabilidadeUniforme').style.display='none'
        document.getElementById('popupProbabilidadeBinomial').style.display='none'
        document.getElementById('popupProbabilidadeNormal').style.display='none'
...
function abrirCorrelacao() {
        document.getElementById('popupDescritiva').style.display='none'
        document.getElementById('popupProbabilidadeEscolha').style.display='none'
        document.getElementById('popupCorrelacao').style.display='block'
        document.getElementById('popupProbabilidadeUniforme').style.display='none'
        document.getElementById('popupProbabilidadeBinomial').style.display='none'
        document.getElementById('popupProbabilidadeNormal').style.display='none'
        document.getElementById('tabela-descritiva').style.display='none'
...
function abrirProbabilidadeUniforme() {
        ...
        document.getElementById('popupProbabilidadeEscolha').style.display='none'
        document.getElementById('popupCorrelacao').style.display='none'
        document.getElementById('popupProbabilidadeUniforme').style.display='block'
        document.getElementById('popupProbabilidadeBinomial').style.display='none'
        document.getElementById('popupProbabilidadeNormal').style.display='none'
        document.getElementById('tabela-descritiva').style.display='none'
        document.getElementById("tabela-probabilidade").style.display = 'none'
